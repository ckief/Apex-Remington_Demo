...
namespace RemingtonDemo.Web
{
    ...
    public class Excel
    {
        public void Main(DateTime start, DateTime end)
        {
            ...
            CustomerInvoice[] invoices = repo.GetAll(start, end).ToArray();
            ...
            var columns = new[]
            {
                ...
                new Column { Title = "Customer PO Number", Style = normalStyle, Action = i => i.CustomerPONumber,},
            ...
            using (FileStream fs = File.Open(HttpContext.Current.Server.MapPath("~/temp/Invoice.xlsx"), FileMode.OpenOrCreate, FileAccess.Write))
            {
